<div class="jumbotron jumbotron-fluid loggedin">
    <h2>Gast <strong><?php echo htmlentities($this->guest[0]['firstname']) . " " . htmlentities($this->guest[0]['lastname']); ?></strong> bearbeiten</h2>
    <form action="<?php echo URL; ?>guests/editSave/<?php echo $this->guest[0]['guest_id']; ?>" method="post">
        ...
        <label for="firstname">Vorname<span class="required-star">*</span></label><input value="<?php echo htmlentities($this->guest[0]['firstname']); ?>" type="text" id="firstname" name="firstname" autocomplete="no"><br>
        <label for="lastname">Nachname<span class="required-star">*</span></label><input value="<?php echo htmlentities($this->guest[0]['lastname']); ?>" type="text" id="lastname" name="lastname" autocomplete="no"><br>
